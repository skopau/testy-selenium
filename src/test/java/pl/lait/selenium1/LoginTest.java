 ...
 * 
 * @author ppp FIX METHOD ORDER.. SORTUJE NAM TESTY PO KOLEI
 */
...
public class LoginTest {
	...
	/**
	 * PODZIELILIŚMY TEST WCZESNIEJSZY NA DWA OSOBNE. PIERWSZY KLKANIE PO MENU,
	 * DRUGI LOGOWANIE
	 */
	@Ignore
	@Test
	...
	public void login() {
		...
		/**
		 * page object, przenosi strone do klasy w kodach, kazdy przycisk to bylby
		 * przycisk w kodzie
		 * 
		 * xpath wklejamy jesli nie mozemy zlokalizowac elementu po nazwie elementu, bo
		 * np. sie powtarzaja
		 */
	...
	/**
	 * DZIĘKI TEMU ŻE MAMY PO AFTER KOMENDE ZAMKNIJ PRZEGLADARKE, TO PO KAZDYM
	 * TESCIE NAM ZAMYKA PRZEGLĄDARKE I OTWIERA NA NOWO, DZIEKI CZEMU NP. NIE ZUŻYWA
	 * NA RAMU
	 */
	@After
	public void close() {
